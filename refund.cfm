<cfoutput>
    ...
    <div class="container-fluid ">
        <div class="row p-3 mt-2 w-100 border shadow-lg p-3 mb-5 bg-body rounded vh-100">
            <div class="12 w-100 text-center"><h5> Refund Order</h5>
                <hr />
            </div>
            <div class="input-group mb-3">
                <div class="col-6"> referenceMerchantTransactionId </div> 
                <div class="col-6"> <input id="referenceMerchantTransactionId" type="text" /> </div> 
                </div>
                <div class="input-group mb-3">
            ...
            <div id="refund-order-res" class="alert alert-info d-none" role="alert">
                A simple info alert—check it out!
            </div>
            <div class="input-group mb-3">
                <div class="col-12 w-100 text-center mt-2" >
                    <button type="button" class="btn btn-secondary" onclick="refundOrderRequest()">Cancel Order</button>
                </div>
            </div>
        </div>
    </div>
